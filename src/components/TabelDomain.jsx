    ...
    <div className='p-4'>
      ...
      <table className="table border-solid border-2">
        ...
        <tbody className='border-solid border-2'>
          {prop.domain.map((kebijakan)=>(
            <tr  key={kebijakan.nomor}>
              <td className='border-solid border-2'>{kebijakan.nomor}</td>
              <td className='border-solid border-2'>{kebijakan.aspek}</td>
              <td className='border-solid border-2'>{kebijakan.indikator}</td>
