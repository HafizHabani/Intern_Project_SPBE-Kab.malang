...
const TabelDomain = (prop) => {
  ...
  const deleteHandler =(ID)=>{
    axios.delete(`${urlAPI}${prop.keterangan}/delete/${ID}`.toLocaleLowerCase())
  }
            ...
            <tr  key={index+1}>
              ...
              <td>
                ...
                <div className='flex flex-row justify-center items-center '>
                  ...
                  {/* Ini button delete */}
                  <button className='btn btn-square bg-red-500 hover:bg-red-800' onClick={()=>{deleteHandler(domain.id); console.log(map)}}> 
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="white" className="w-6 h-6">
        ...
        <div className="modal-box w-5/12 max-w-5xl">
          ...
          <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
              ...
              <div className="mb-4">
                ...
                <input type="text" id="nilai" name='nilai' onSubmit={handleChange} onChange={handleChange} defaultValue={map.penjelasan} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required></input>
              </div>
              <div className="mb-4">
                <label htmlFor="tahun" className="block text-gray-700 text-sm font-bold mb-2">Tahun:</label>
                <input type="text" id="tanun" name='tahun' onSubmit={handleChange} onChange={handleChange} defaultValue={map.penjelasan} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required></input>
              </div>
            </div>
        ...
        <h3 className="font-bold text-lg">Edit Indikator</h3>
          ...
          <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            ...
            <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
              <button type="submit" className="btn bg-primary text-base font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 sm:ml-3 sm:w-auto sm:text-sm">
                Update
              </button>
            </div>
          </form>
