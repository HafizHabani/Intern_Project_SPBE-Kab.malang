...
const TabelGaleri = (props) => {
    ...
    <div className='p-4'>
      ...
      <table className="table border-solid border-2">
        ...
        <tr>
            ...
            <th className='border-solid border-2'>Judul Kegiatan</th>
  ...
  <div className="modal-box w-11/12 max-w-5xl">
    ...
    <h3 className="font-bold text-lg">Tambah Kegiatan</h3>
  ...
  <dialog id="my_modal_3" className="modal">
        ...
        <form method="dialog">
          ...
          <h3 className="font-bold text-lg">Ubah Foto Kegiatan</h3>
