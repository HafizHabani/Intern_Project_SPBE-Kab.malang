...
const TabelLayanan = (props) => {
  ...
  const [layanan, setGaleri] = React.useState(props.layanan);
  ...
  const getData = async () => {
    const data = await axios.get(`${urlAPI}layanan/show`);
    setGaleri(data.data);
  };
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append("logo", file); // Simpan file logo dalam FormData
    formData.append("nama", data.nama);
    formData.append("link", data.link);
    formData.append("deskripsi", data.deskripsi);

    axios
      .post(`${urlAPI}layanan/uploadgambar`, formData)
      .then((response) => {
  ...
  const handleSubmitUpdate = (e) => {
    ...
    axios
      .post(`${urlAPI}layanan/updategambar/${id}`.toLocaleLowerCase(), formData)
      .then((response) => {
        console.log(response);
