            ...
            <tr key={index}>
              ...
              <td>
                <div className="flex flex-row justify-center items-center ">
                  <button
                    className="btn btn-square bg-emerald-400 hover:bg-emerald-700"
                    onClick={() => {
                      setDataNews(berita);
        ...
        <div className="modal-box w-11/12 max-w-5xl">
          ...
          >
            ...
            <input
              ...
              className="input input-md input-bordered w-3/5 mb-3"
            />
            <div className="label">
            ...
            <div className="modal-action flex-row">
              <button
                type="submit"
                className="btn bg-emerald-400 hover:bg-emerald-700 text-white"
              >
                Save
              </button>
            </div>
