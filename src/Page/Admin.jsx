  ...
  return (
    <div>
      ...
      <div className="flex flex-row">
        ...
        <div className="">
          {component == 0 && (
            <TabelDomain domain={kebijakanDummy.data} keterangan="Kebijakan" />
          )}
          {component == 1 && (
            <TabelDomain
              domain={manajemenDummy.data.data}
              keterangan="Manajemen"
            />
          )}
          {component == 2 && (
            <TabelDomain
              domain={kelolaDummy.data.data}
              keterangan="Tata Kelola"
            />
          )}
          {component == 4 && (
            <TabelBerita berita={newsDummy.data} keterangan="Berita" />
          )}
          {component == 5 && (
            <TabelGaleri galeri={galleryPhoto.data} keterangan="Galeri" />
          )}
          {component == 6 && (
            <TabelGaleri
              galeri={galleryPhoto.data}
              keterangan="Nilai Indikator SPBE"
            />
          )}
        </div>
      </div>
